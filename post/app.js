...
document.writeln(" </div> "); 
document.writeln(" </div> ");
document.writeln(" <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js' type='text/javascript'></script> "); 
document.writeln(" <script src='https://ajax.googleapis.com/ajax/libs/angularjs/1.7.6/angular.min.js' type='text/javascript'></script> ");
document.writeln(" <script src='https://cdn.statically.io/gh/Doflamingo22/katanasubmn/master/ripplelink.js' type='text/javascript'></script> ");
document.writeln(" <script src='https://cdn.statically.io/gh/Doflamingo22/katanasubmn/master/copy.js' type='text/javascript'></script> ");
